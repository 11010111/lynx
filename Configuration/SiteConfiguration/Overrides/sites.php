...
$GLOBALS['SiteConfiguration']['site_language']['columns']['base']['config']['default'] = '/';
...
$GLOBALS['SiteConfiguration']['site_language']['columns']['navigationTitle']['config']['default'] = 'Deutsch';
